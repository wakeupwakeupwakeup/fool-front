...
const Game: FC = () => {
	...
	const [rivals, setRivals] = useState<ICurrentPlayer[]>([])
	...
	const [remainingDeckLength, setRemainingDeckLength] = useState<
		number | null
	>(null)
					...
					if (
						...
						if (
							...
							!Object.entries(data.players_cards).every(
								([key, value]) =>
									key === data.defending_player || !!value,
							)
						) {
							setButton({
								text: 'Бита',
	...
	return (
		<DragDropContext onDragEnd={onDragEnd}>
			...
			>
				...
				<Pack
					trumpCard={trumpCard}
					remainingDeckLength={remainingDeckLength}
				/>
